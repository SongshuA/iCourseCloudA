...
<html>
<head>
    <title>注册 - <%=GlobalConfig.siteName%></title>
...
<div class="page-container z-depth-2">
    <div class="row">
        <form name="login-static" class="col s12" method="POST" action="/register">
            <h4 class="center-align">注册</h4>
            ...
            <div class="right">
                <a href="javascript:util.submit('login-static')" class="waves-effect waves-green btn-flat">注册</a>
            </div>
        </form>
    </div>
